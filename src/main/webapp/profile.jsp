...
<%
    ...
    char    initial = user != null && user.getName().length() > 0
                      ? Character.toUpperCase(user.getName().charAt(0)) : 'U';
    boolean isAdmin = user != null && user.getRole() == User.Role.ADMIN;
    String  backUrl = isAdmin ? "/admin/dashboard" : "/dashboard";
%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<nav class="navbar">
    <div class="navbar-inner">
        <a class="navbar-brand" href="${pageContext.request.contextPath}<%= backUrl %>">
            I<span class="dot">-VOTE</span>
        </a>
        <div class="navbar-links">
            <a href="${pageContext.request.contextPath}<%= backUrl %>">Dashboard</a>
            <% if (!isAdmin) { %>
...
<div class="page-wrap">
    ...
    <div class="profile-wrap">
        ...
        <div class="profile-sidebar">
            ...
            <% if (isAdmin && user.getUniversityName() != null && !user.getUniversityName().isBlank()) { %>
                <div style="font-size: 13px; color: var(--slate); text-align: center; margin-top: 4px;">
                    <%= user.getUniversityName() %>
                    <% if (user.getUniversityLocation() != null && !user.getUniversityLocation().isBlank()) { %>
                        <br><%= user.getUniversityLocation() %>
                    <% } %>
                </div>
            <% } %>
        ...
        <div class="profile-main">
            ...
            <div class="card">
                ...
                <form method="post" action="${pageContext.request.contextPath}/profile">
                    ...
                    <button type="submit" class="btn btn-primary">Save Name and Email</button>
                </form>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-subtitle">
                    ...
                    Make sure the new number is not registered to another account.
                </div>
                <form method="post" action="${pageContext.request.contextPath}/profile">
            ...
            <div class="card">
                ...
                <div class="card-subtitle">
                    Update your university or institution name and location.
                    This appears on all elections you create.
                </div>
                <form method="post" action="${pageContext.request.contextPath}/profile">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="universityName" name="universityName" class="form-control"
                                   value="<%= user.getUniversityName() != null ? user.getUniversityName() : "" %>"
                                   placeholder="e.g. ABC University" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="universityLocation">Location</label>
                            <input type="text" id="universityLocation" name="universityLocation" class="form-control"
                                   value="<%= user.getUniversityLocation() != null ? user.getUniversityLocation() : "" %>"
            ...
            <div class="card">
                ...
                <div style="display: flex; flex-direction: column;">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center;
                                padding: 12px 0;
                                <%= isAdmin ? "border-bottom: 1px solid var(--fog);" : "" %>">
                        <span style="font-size: 14px; color: var(--slate);">Phone</span>
                        <span style="font-size: 14px; font-weight: 500; color: var(--ink);">
                            <%= user.getPhone() %>
                        </span>
                    </div>
                    <% if (isAdmin && user.getUniversityName() != null) { %>
                    <div style="display: flex; justify-content: space-between; align-items: center;
                                padding: 12px 0;">
                        <span style="font-size: 14px; color: var(--slate);">Institution</span>
                        <span style="font-size: 14px; font-weight: 500; color: var(--ink);">
                            <%= user.getUniversityName() %>
                        </span>
                    </div>
